"""ReSpeaker 4-Mic Array hardware control and tuning"""

from .respeaker import ReSpeakerController
import usb.core
import usb.util
import struct

__all__ = ['ReSpeakerController', 'find', 'Tuning']
...
def find(vid=0x2886, pid=0x0018):
    """Find and return ReSpeaker USB device for direct tuning control"""
